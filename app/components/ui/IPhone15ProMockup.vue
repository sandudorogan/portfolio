...
<template>
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" :width="width" :height="height" viewBox="0 0 433 882">
        <path
        ...
        <path
            ...
            class="fill-[#E5E5E5] dark:fill-[#404040] stroke-[#E5E5E5] stroke-[0.5] dark:stroke-[#404040]" />
        <image v-if="src" x="21.25" y="19.25" width="389.5" height="843.5" preserveAspectRatio="xMidYMin meet"
            style="clip-path: url(#roundedCorners)" :href="src" />
